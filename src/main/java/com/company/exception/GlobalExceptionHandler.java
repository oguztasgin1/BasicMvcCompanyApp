...
import static com.company.exception.EErrorType.BAD_REQUEST_ERROR;
import static com.company.exception.EErrorType.INTERNAL_ERROR;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(BasicCompanyAppProjectException.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> handleSpringMonoException(BasicCompanyAppProjectException exception){
